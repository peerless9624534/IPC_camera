...
int misc_init_r(void)
{
    ...
    //gpio_direction_output(GPIO_PA(9), 1);   //LED GREEN
    gpio_direction_output(GPIO_PA(10), 1);  //LED RED
    gpio_direction_output(GPIO_PB(17), 1);  //AC SD CARD POWER
    gpio_direction_output(GPIO_PA(11), 1);  //PTZ SD CARD POWER
