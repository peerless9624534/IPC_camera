...
#define START_INI_CONFIG_FILE_NAME	"media_config.ini"
#define TUYA_INI_CONFIG_FILE_NAME   "tuya_config.ini"
#define INGENIT_ALG_FILE_NAME       "/system/etc/license.txt"
#define AUDIO_PCM_FILE_PATH         "/system/bin/audio/"
#define UNNORMAL_REBOOT_FILE_NAME   "/system/etc/unnormalReboot"    //非常规重启标识文件
