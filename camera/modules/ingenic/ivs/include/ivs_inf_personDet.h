...
typedef struct {
    ...
    float pred_factor;  /**控制 pred_box 超前量系数 0.0 ~ 3.0 default 1.5*/
...
typedef struct {
    ...
    bool person_flag; /**true : person detected, false : no person detected; 当 enable_move==true 时生效 */
