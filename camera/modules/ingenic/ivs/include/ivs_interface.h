...
/**
 * @fn IMPIVSInterface *SmileDetInterfaceInit(void *param)
 *
 * 笑脸检测接口初始化结构体
 *
 * @inf[in] 笑脸检测接口初始化参数
 ...
 * @retval NULL 失败
 *
 * @retval 非NULL 初始化成功，返回笑脸检测接口结构体句柄
 *
 * @attention 无
 */
IMPIVSInterface *SmileDetInterfaceInit(void *param);
/**
 * @fn void SmileDetInterfaceExit(IMPIVSInterface *inf)
 *
 *  笑脸检测去初始化结构体句柄
 *
 * @inf[in]  笑脸检测接口结构体句柄
 ...
 * @attention 无
 */
void SmileDetInterfaceExit(IMPIVSInterface *inf);
